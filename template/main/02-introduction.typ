...
#option-style(type:option.type)[
  Your introduction serves to introduce the topic of your thesis and to arouse the reader’s curiosity with an overview. Why it is important and how it is structured, we explain here.

  You can consider an introduction as a teaser for your thesis. You arouse interest and give a foretaste by presenting your motivation, your method and the state of research in your introduction.

  Convince your examiners already in the introduction that your thesis will be exciting. If your professor starts reading your thesis with anticipation and interest, the chances of getting good grades are higher.
  ...
  - *Describe the relevance* - Why is this thesis scientifically relevant?
  ...
  - *Objectives* - Your introduction should clearly state what the goal of your paper is and what outcome you hope to achieve upon completion of your thesis.
  - *Method* - You explain the approach and justify the choice of method.
  - *Structure of the thesis* - Finally, you give the reader a general overview of your  thesis by explaining the structure, showing the red thread and how the research question is answered.
]
...
Acronym terms like #gls("cs") expand on first use and abbreviate after #gls("cs"). Glossary items such as #gls("rust") can also be used to show their description as such: #gls-description("rust"). Acronyms and glossary entries auto-generate at the document’s end (defined in `/tail/glossary.typ`).
